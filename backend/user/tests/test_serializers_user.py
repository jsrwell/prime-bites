...
class UserSerializerTest(TestCase):
    ...
    def test_create_user_serializer_valid_data_email(self):
    ...
    def test_create_user_serializer_valid_data_first_name(self):
    ...
    def test_create_user_serializer_valid_data_last_name(self):
    ...
    def test_create_user_serializer_invalid_data(self):
